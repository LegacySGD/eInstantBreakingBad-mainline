...
public class BreakingBadCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BreakingBadCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BreakingBadIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BreakingBadIW/InitOutcome.xml").getDocumentElement();
